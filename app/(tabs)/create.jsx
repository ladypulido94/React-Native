                ...
                <View className="mt-7 space-y-2">
                    ...
                    <TouchableOpacity onPress={() => openPicker('video')} >
                        {form.video ? (
                            ...
                            bg-black-100 rounded-2xl justify-center items-center">
                                <View className="w-14 h-14 border border-dashed border-secondary
                ...
                <View className="mt-7 space-y-2">
                    ...
                    <TouchableOpacity onPress={() => openPicker('image')}>
                        {form.thumbnail ? (
                            ...
                            items-center border-2 border-black-200
                            flex-row space-x-2">
                                <Image source={icons.upload}
                                       resizeMode="contain"
                                       className="w-5 h-5"/>
